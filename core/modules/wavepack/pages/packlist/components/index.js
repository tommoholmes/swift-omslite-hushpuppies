    ...
    return (
        <>
            <Button
                ...
                onClick={() => router.push('/pickpack/wavepack')}
                variant="contained"
                ...
                <div className={classes.headerContent}>
                    ...
                    <div className={classes.grid}>
                        <div className="grid-child">
                            <h5 className={classes.titleSmall}>{`Date : ${packList.date}`}</h5>
                        </div>
                        <div className="grid-child">
                            <h5 className={classes.titleSmall}>{`Picker : ${packList.picker}`}</h5>
                        </div>
                        <div className="grid-child">
                            <h5 className={classes.titleSmall}>{`Total Shipment : ${packList.totalShipments}`}</h5>
                        </div>
                        <div className="grid-child">
                            <h5 className={classes.titleSmall}>{`Total SKU : ${packList.totalItems}`}</h5>
                        </div>
                    </div>
                </div>
