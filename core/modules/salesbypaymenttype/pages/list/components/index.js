...
import Header from '@modules/salesbypaymenttype/pages/list/components/Header';
...
const PaymentTypeContent = (props) => {
    ...
    const columns = [
        { field: 'company_code', headerName: 'Payment Method (Code)' },
        ...
        { field: 'company_code', headerName: 'Avg. Order Amount' },
...
export default PaymentTypeContent;
