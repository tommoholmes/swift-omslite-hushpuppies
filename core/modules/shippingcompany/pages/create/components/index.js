...
import useStyles from '@modules/shippingcompany/pages/create/components/style';

const ShippingCompanyCreateContent = (props) => {
    const {
        formik,
    } = props;
    ...
    return (
        <>
            ...
            <h2 className={classes.titleTop}>Add New Shipping Company</h2>
            <Paper className={classes.container}>
                <div className={classes.content}>
                    <div className={classes.formField}>
                        <div className={classes.divLabel}>
                            <span className={clsx(classes.label, classes.labelRequired)}>Company ID</span>
                        </div>
                        <TextField
                    ...
                    <div className={classes.formField}>
                        <div className={classes.divLabel}>
                            <span className={clsx(classes.label, classes.labelRequired)}>Brand</span>
                        </div>
                        <TextField
                            className={classes.fieldRoot}
                            variant="outlined"
                    ...
                    <div className={classes.formField}>
                        <div className={classes.divLabel}>
                            <span className={clsx(classes.label, classes.labelRequired)}>Is Active</span>
                        </div>
                        <Autocomplete
...
export default ShippingCompanyCreateContent;
