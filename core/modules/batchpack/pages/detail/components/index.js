    ...
    return (
        <>
            <Button
                ...
                onClick={() => router.push('/pickpack/batchpack')}
                variant="contained"
                        ...
                        {nextShipment
                            && (
                                <button
                                    ...
                                    type="submit"
                                    onClick={() => router.push(`/pickpack/batchpack/detail/${nextShipment}`)}
                                >
                                    Pack Next Shipment
                                </button>
                            )}
                        <div style={{ height: 18 }} />
                        <h5 className={classes.spanBack} onClick={() => router.push('/pickpack/batchpack')}>
                            Back to Pack List
                        </h5>
                    </div>
                </Fade>
