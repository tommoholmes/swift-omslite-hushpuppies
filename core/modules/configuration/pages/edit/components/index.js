...
const ConfigurationTadaEditContent = (props) => {
    ...
    return (
        <>
            ...
            <h2 className={classes.titleTop}>Edit Configuration</h2>
            <Paper className={classes.container}>
                <div className={classes.content}>
                    ...
                    <div className={classes.formField}>
                        <div className={classes.divLabel}>
                            <span className={classes.label}>Api Secret</span>
                        </div>
                        <TextField
                            className={classes.fieldRoot}
                            variant="outlined"
                    ...
                    <div className={classes.formField}>
                        <div className={classes.divLabel}>
                            <span className={classes.label}>Program ID</span>
                        </div>
                        <TextField
                            className={classes.fieldRoot}
                            variant="outlined"
                    ...
                    <div className={classes.formField}>
                        <div className={classes.divLabel}>
                            <span className={classes.label}>Catalog ID</span>
                        </div>
                        <TextField
                            className={classes.fieldRoot}
                            variant="outlined"
...
export default ConfigurationTadaEditContent;
